  ...
  test('accepts legacy client gacha setup piece codes', async () => {
    ...
    const game = createInitialGameFromBattleSetups({
      ...
      blackSetup: {
        ...
        status: 'locked',
        name: 'black',
        boardLayout: [{ row: 4, col: 4, pieceId: 127, pieceCode: 'PIECE_GACHA_KOU' }],
        handsLayout: [],
        selectedPieceIds: [127],
        validationSummary: { boardPieceCount: 1, handPieceCount: 0, totalSelectedPieces: 1 },
        createdAt: '2026-05-10T00:00:00.000Z',
        updatedAt: '2026-05-10T00:00:00.000Z',
      },
      whiteSetup: {
        ...
        status: 'locked',
        name: 'white',
        boardLayout: [{ row: 0, col: 4, pieceId: 3, pieceCode: 'OU' }],
        handsLayout: [],
        selectedPieceIds: [3],
        validationSummary: { boardPieceCount: 1, handPieceCount: 0, totalSelectedPieces: 1 },
        createdAt: '2026-05-10T00:00:00.000Z',
    ...
    expect(game.boardState['5e']).toBe('black:GACHA_KOU');
  });
});
